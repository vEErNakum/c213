...
def number_of_vehicle():
    ...
    if len(all_vehicles) > 1:
        ...
        for distance_of_car, vehicle in sorted_vehicle:
            if distance_of_car > 200.0:
                ...
                for distance_in_meter in final_vehicle_result:
                    if distance_in_meter['distance'] > 6 and distance_in_meter['distance'] < 10:
                        ...
                        time.sleep(3) 
                        car_control()
                if distance_in_meter['disatnce'] > 1 and disatnce_in_meter['distance'] < 5:
                    print("Close car")
...
def car_control():
    ...
    dropped_vehicle.set_light_state(carla.VehicleLightState(carla.VehicleLightState. | 
